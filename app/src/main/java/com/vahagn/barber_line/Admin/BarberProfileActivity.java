    ...
    private void setInfo(Integer barberShopsId, Integer barberId) {
        ...
        barberRef.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                SpecialistsFragment.imageUrl = barber.getImage();
                SpecialistsFragment.name = barber.getName();
                SpecialistsFragment.rating = barber.getRating();
                SpecialistsFragment.ListServices = barber.getServices();
